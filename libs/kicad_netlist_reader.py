...
class comp():
    ...
    def getValue(self):
        val = self.element.get("value")
        if val == "DNP": val = "DO NOT POPULATE"
        return val
    ...
    def getSupplier(self, libraryToo=True):
        field = self.element.get("field", "name", 'Supplier')
        if field == "" and libraryToo:
            field = self.libpart.getField('Supplier')
        return field[:field.find(':')]

    def getSupplierNumber(self, libraryToo=True):
        field = self.element.get("field", "name", 'Supplier')
        if field == "" and libraryToo:
            field = self.libpart.getField('Supplier')
        i = field.find(':')+1
    ...
    def getSupplierPrice(self, libraryToo=True):
        field = self.element.get("field", "name", 'Supplier')
        if field == "" and libraryToo:
            field = self.libpart.getField('Supplier')
        i = field.find(':$')
